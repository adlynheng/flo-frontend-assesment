    ...
    return (
        <div className="w-2xl">
            <p className='text-center text-sm text-zinc-500 font-medium mb-4'>Convert NEM12 electrical meter readings to SQL INSERT statements </p>
                <section className="flex flex-col bg-white outline-2 outline-dashed outline-neutral-200 pt-18 pb-24 rounded-md justify-center items-center">
                        <div className='flex justify-center'>
                            <div className='loader p-2 rounded-full'>
                        ...
                        <div className='flex items-center gap-1 bg-slate-200 px-4 py-1 rounded-2xl'>
                            ...
                            <span className='text-sm mr-1 text-slate-700 font-medium'>{fileName}</span> 
