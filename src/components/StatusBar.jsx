        ...
        <div className="w-full flex justify-between items-center rounded-lg bg-white border border-zinc-200 py-2 pl-4 pr-2 mb-6">
            <div className="flex gap-4">
                ...
                <div className="flex gap-1">
                    ...
                    <span className="font-mono text-emerald-700">1080</span>
                </div>
                <div className="flex gap-1">
            ...
            <div className="flex gap-2">
                <Button className="flex gap-2 items-center py-1 px-4 border border-neutral-200 text-zinc-500 text-sm font-medium rounded-lg hover:bg-neutral-100">
                    <Undo2 size={16}/>
                    New file
                </Button>
